...
SET time_zone = "+00:00";
CREATE DATABASE IF NOT EXISTS `vue-blog` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `vue-blog`;

CREATE TABLE IF NOT EXISTS `vue-blog`.`users` (
...
CREATE TABLE IF NOT EXISTS `vue-blog`.`files` (
`id` CHAR(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vue-blog`.`posts` (
`id` CHAR(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vue-blog`.`user_posts` (
...
CREATE TABLE IF NOT EXISTS `vue-blog`.`post_files` (
`post_id` CHAR(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
